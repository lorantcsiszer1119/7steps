  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved opening as @opening" do
        ...
        post :create, {:opening => { "user_id" => "invalid value" }}, valid_session
        assigns(:opening).should be_a_new(Opening)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested opening" do
        ...
        Opening.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => opening.to_param, :opening => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the opening as @opening" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Opening.any_instance.stub(:save).and_return(false)
        put :update, {:id => opening.to_param, :opening => { "user_id" => "invalid value" }}, valid_session
        assigns(:opening).should eq(opening)
      end
