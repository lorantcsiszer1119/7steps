...
var style = ".buorg {position:fixed;z-index:111111;display:table;\
 top:0px; right:0px; \
border-bottom:1px solid #A29330; \
background:#FDF2AB no-repeat 10px center url(http://browser-update.org/img/dialog-warning.gif);\
text-align:left; cursor:pointer; \
font-family: Arial,Helvetica,sans-serif; color:#000; font-size: 12px;}\
.buorg div { display:table-cell; vertical-align: middle; padding:5px 36px 5px 40px; } \
.buorg a,.buorg a:visited  {color:#E25600; text-decoration: underline;}\
@media only screen and (min-width: 768px) { \
.buorg { width:92%; width: calc(97% - 40px); margin: 0 auto;height:47px;} } \
@media only screen and (min-width: 1280px) { \
.buorg { width:92%; width: calc(92% - 60px); } } \
@media only screen and (min-width: 1440px) { \
.buorg { width:92%; width: calc(92% - 60px); } } \
#buorgclose { position: fixed; right: .5em; top:3.5%; height: 20px; width: 12px; font-weight: bold;font-size:14px; padding:0; }";
